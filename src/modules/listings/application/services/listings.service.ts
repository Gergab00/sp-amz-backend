...
export class ListingsService {
   ...
   * @param dto DTO con parámetros de consulta
 ...
 * el controller delgado y facilitando la extensión del dominio. Extender:
 * agrega nuevos métodos para otros casos de uso. Modificar: ajusta la
 * orquestación para soportar nuevos flujos o dependencias.
 * ============================================================= */
