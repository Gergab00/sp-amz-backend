...
describe('MfnQuantity Entity', () => {
  describe('create', () => {
    it('should create a valid MfnQuantity entity', () => {
      const entity = MfnQuantity.create('TEST-SKU-001', 'A1AM78C64UM0Y8', 50, 'DEFAULT');
  ...
  describe('isAvailable', () => {
    it('should return true when quantity is greater than 0', () => {
      const entity = MfnQuantity.create('TEST-SKU-001', 'A1AM78C64UM0Y8', 10, 'DEFAULT');
      expect(entity.isAvailable()).toBe(true);
    });

    it('should return false when quantity is 0', () => {
      const entity = MfnQuantity.create('TEST-SKU-001', 'A1AM78C64UM0Y8', 0, 'DEFAULT');
      expect(entity.isAvailable()).toBe(false);
    });
  });

  describe('canFulfillOrder', () => {
    const entity = MfnQuantity.create('TEST-SKU-001', 'A1AM78C64UM0Y8', 20, 'DEFAULT');
    ...
    it('should throw error when requested quantity is not positive', () => {
      expect(() => entity.canFulfillOrder(0)).toThrow('Requested quantity must be positive');
      expect(() => entity.canFulfillOrder(-5)).toThrow('Requested quantity must be positive');
    });
  });
  ...
  describe('reduceQuantity', () => {
    ...
    it('should throw error when reducing more than available', () => {
      ...
      expect(() => entity.reduceQuantity(15)).toThrow('Insufficient quantity available');
    });

    it('should throw error when quantity to reduce is not positive', () => {
      const entity = MfnQuantity.create('TEST-SKU-001', 'A1AM78C64UM0Y8', 50, 'DEFAULT');
      
      expect(() => entity.reduceQuantity(0)).toThrow('Quantity to reduce must be positive');
      expect(() => entity.reduceQuantity(-5)).toThrow('Quantity to reduce must be positive');
    });
  });
  ...
  describe('increaseQuantity', () => {
    ...
    it('should throw error when quantity to increase is not positive', () => {
      ...
      expect(() => entity.increaseQuantity(0)).toThrow('Quantity to increase must be positive');
      expect(() => entity.increaseQuantity(-10)).toThrow('Quantity to increase must be positive');
    });
  });

  describe('isBelowThreshold', () => {
    const entity = MfnQuantity.create('TEST-SKU-001', 'A1AM78C64UM0Y8', 15, 'DEFAULT');
    ...
    it('should throw error when threshold is negative', () => {
      expect(() => entity.isBelowThreshold(-5)).toThrow('Threshold cannot be negative');
    });
  });
  ...
  describe('getStockLevel', () => {
    ...
    it('should return "low" when quantity is below low threshold', () => {
      const entity = MfnQuantity.create('TEST-SKU-001', 'A1AM78C64UM0Y8', 5, 'DEFAULT');
      expect(entity.getStockLevel()).toBe('low');
    });

    it('should return "medium" when quantity is between low and high thresholds', () => {
      const entity = MfnQuantity.create('TEST-SKU-001', 'A1AM78C64UM0Y8', 30, 'DEFAULT');
    ...
    it('should return "high" when quantity is at or above high threshold', () => {
      ...
      const entity2 = MfnQuantity.create('TEST-SKU-002', 'A1AM78C64UM0Y8', 100, 'DEFAULT');
      expect(entity2.getStockLevel()).toBe('high');
    });

    it('should respect custom thresholds', () => {
      const entity = MfnQuantity.create('TEST-SKU-001', 'A1AM78C64UM0Y8', 25, 'DEFAULT');
  ...
  describe('hasMoreQuantityThan', () => {
    it('should return true when this entity has more quantity', () => {
      const entity1 = MfnQuantity.create('TEST-SKU-001', 'A1AM78C64UM0Y8', 50, 'DEFAULT');
      const entity2 = MfnQuantity.create('TEST-SKU-002', 'A1AM78C64UM0Y8', 30, 'DEFAULT');
      
      expect(entity1.hasMoreQuantityThan(entity2)).toBe(true);
    });

    it('should return false when this entity has equal or less quantity', () => {
      const entity1 = MfnQuantity.create('TEST-SKU-001', 'A1AM78C64UM0Y8', 30, 'DEFAULT');
      const entity2 = MfnQuantity.create('TEST-SKU-002', 'A1AM78C64UM0Y8', 30, 'DEFAULT');
      const entity3 = MfnQuantity.create('TEST-SKU-003', 'A1AM78C64UM0Y8', 50, 'DEFAULT');
